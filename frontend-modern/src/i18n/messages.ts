...
export const EN_MESSAGES = {
  ...
  'alerts.overview.action.cancel': 'Cancel',
  ...
  'alerts.overview.action.resume': 'Resume',
  'alerts.overview.action.showAcknowledged': 'Show acknowledged',
  'alerts.overview.action.timeline': 'Timeline',
  'alerts.overview.action.snooze': 'Snooze',
  'alerts.overview.action.unacknowledge': 'Unacknowledge',
  'alerts.overview.group.acknowledge': 'Acknowledge all ({count})',
  'alerts.overview.group.hide': 'Hide',
  'alerts.overview.group.linkedSignal': '+{count} linked signal',
  'alerts.overview.group.linkedSignals': '+{count} linked signals',
  'alerts.overview.group.related': '+{count} related',
  'alerts.overview.synthesis.title.supported': 'Supported infrastructure cause',
  'alerts.overview.synthesis.title.observationSet': 'Related observation set',
  'alerts.overview.synthesis.failure.runtime': 'Runtime',
  'alerts.overview.synthesis.failure.networkPath': 'Network path',
  'alerts.overview.synthesis.failure.applicationResponse': 'Application response',
  'alerts.overview.synthesis.failure.certificate': 'Certificate',
  'alerts.overview.synthesis.failure.dependency': 'Dependency',
  'alerts.overview.synthesis.failure.evidenceCoverage': 'Evidence coverage',
  'alerts.overview.synthesis.counts': '{affected} affected resources · {observations} observations',
  'alerts.overview.synthesis.review': 'Review synthesis evidence',
  'alerts.overview.synthesis.challenge.supported':
    'Expand every linked signal below and compare its timing before accepting this cause.',
  'alerts.overview.synthesis.challenge.observationSet':
    'These observations are related, but Pulse has not established a root cause.',
  ...
  'alerts.overview.hydration.pending.description':
    'Pulse is confirming the current incident state before reporting an all-clear.',
  'alerts.overview.hydration.pending.title': 'Checking active alerts',
  'alerts.overview.hydration.retry': 'Retry',
  ...
  'alerts.overview.hydration.unavailable.title': 'Active alert status is temporarily unavailable',
  ...
  'alerts.overview.notification.resumed': 'Alert notifications resumed',
  'alerts.overview.notification.resumeFailed': 'Failed to resume alert notifications',
  'alerts.overview.notification.snoozed': 'Alert snoozed until {until}',
  'alerts.overview.notification.snoozeFailed': 'Failed to snooze alert',
  ...
  'alerts.overview.snooze.option.eightHours': 'For 8 hours',
  'alerts.overview.snooze.option.oneHour': 'For 1 hour',
  'alerts.overview.snooze.option.sevenDays': 'For 7 days',
  'alerts.overview.snooze.option.tomorrowMorning': 'Until tomorrow at 9:00',
  'alerts.overview.snooze.option.twoHours': 'For 2 hours',
  'alerts.overview.snooze.title': 'Snooze this alert',
  'alerts.overview.snoozedUntil': 'Snoozed until {until}',
  ...
  'alerts.timeline.event.alertSnoozed': 'Snoozed',
  'alerts.timeline.event.alertUnsnoozed': 'Resumed',
...
export const ALERTS_OVERVIEW_MIGRATED_MESSAGE_KEYS = [
  ...
  'alerts.overview.action.cancel',
  'alerts.overview.action.hideAcknowledged',
  'alerts.overview.action.hideTimeline',
  'alerts.overview.action.processing',
  'alerts.overview.action.resume',
  'alerts.overview.action.showAcknowledged',
  'alerts.overview.action.timeline',
  'alerts.overview.action.snooze',
  'alerts.overview.action.unacknowledge',
  'alerts.overview.group.acknowledge',
  'alerts.overview.group.hide',
  'alerts.overview.group.linkedSignal',
  'alerts.overview.group.linkedSignals',
  'alerts.overview.group.related',
  'alerts.overview.synthesis.title.supported',
  'alerts.overview.synthesis.title.observationSet',
  'alerts.overview.synthesis.failure.runtime',
  'alerts.overview.synthesis.failure.networkPath',
  'alerts.overview.synthesis.failure.applicationResponse',
  'alerts.overview.synthesis.failure.certificate',
  'alerts.overview.synthesis.failure.dependency',
  'alerts.overview.synthesis.failure.evidenceCoverage',
  'alerts.overview.synthesis.counts',
  'alerts.overview.synthesis.review',
  'alerts.overview.synthesis.challenge.supported',
  'alerts.overview.synthesis.challenge.observationSet',
  ...
  'alerts.overview.hydration.pending.description',
  'alerts.overview.hydration.pending.title',
  'alerts.overview.hydration.retry',
  'alerts.overview.hydration.unavailable.description',
  ...
  'alerts.overview.notification.resumed',
  'alerts.overview.notification.resumeFailed',
  'alerts.overview.notification.snoozed',
  'alerts.overview.notification.snoozeFailed',
  'alerts.overview.paused.description',
  'alerts.overview.paused.title',
  'alerts.overview.section.activeAlerts',
  'alerts.overview.snooze.description',
  'alerts.overview.snooze.option.eightHours',
  'alerts.overview.snooze.option.oneHour',
  'alerts.overview.snooze.option.sevenDays',
  'alerts.overview.snooze.option.tomorrowMorning',
  'alerts.overview.snooze.option.twoHours',
  'alerts.overview.snooze.title',
  'alerts.overview.snoozedUntil',
  ...
  'alerts.timeline.event.alertSnoozed',
  'alerts.timeline.event.alertUnsnoozed',
...
export const I18N_RUNTIME_MESSAGE_LOADERS = {
  ...
  'zh-Hans': () => import('./messages.zh-Hans').then((module) => module.ZH_HANS_MESSAGE_OVERRIDES),
} as const;
